...
class _GererLivresEcranState extends State<GererLivresEcran>
  ...
  List<Livre> get _livresFiltres {
    ...
    switch (_filtreActuel) {
      case 'disponibles':
        resultat = resultat.where((livre) => livre.estDisponible).toList();
        break;
      case 'en_cours':
        resultat = resultat.where((livre) => !livre.estDisponible).toList();
        break;
      case 'echanges':
        // Filtrer les livres qui ont des transactions en cours
        final idsLivresEchanges = _mesTransactions
            .where((t) => t.statut == 'en_attente' || t.statut == 'en_cours')
            .map((t) => t.livreId)
            .toSet();
        resultat = resultat.where((livre) => idsLivresEchanges.contains(livre.id)).toList();
        break;
      default:
  ...
  Widget _construireFiltres() {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(
            color: CouleursApp.texteFonce.withValues(alpha: 0.05),
            blurRadius: 8,
      ...
      child: Column(
        ...
        children: [
          ...
          SingleChildScrollView(
            ...
            child: Row(
              children: [
                _construireFiltreChip('Tous', 'tous', Icons.all_inclusive),
                const SizedBox(width: 8),
                _construireFiltreChip('Disponibles', 'disponibles', Icons.check_circle_outline),
                const SizedBox(width: 8),
                _construireFiltreChip('En cours', 'en_cours', Icons.sync),
                const SizedBox(width: 8),
                _construireFiltreChip('Échanges', 'echanges', Icons.swap_horiz),
              ],
            ),
          ),
        ],
    ...
    return FilterChip(
      ...
      side: BorderSide(
        color: estSelectionne
            ...
            : CouleursApp.texteFonce.withValues(alpha: 0.3),
        width: 1,
      ),
  ...
  Widget _construireFiltreChipMatiere(String matiere) {
    ...
    return FilterChip(
      ...
      checkmarkColor: CouleursApp.blanc,
      side: BorderSide(
        color: estSelectionne ? couleur : couleur.withValues(alpha: 0.3),
        width: 1,
      ),
      padding: const EdgeInsets.symmetric(horizontal: 12, vertical: 8),
      shape: RoundedRectangleBorder(
      ...
      child: Column(
        ...
        children: [
          Icon(Icons.menu_book_outlined,
              size: 60, color: CouleursApp.texteFonce.withValues(alpha: 0.5)),
          ...
          children: [
            Container(
              ...
              child: const Icon(Icons.swap_horiz,
                  size: 50, color: CouleursApp.principal),
            ),
                      ...
                      child: Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              _obtenirNomLivre(estVendeur
                                  ? transaction.livreId
                                  : (transaction.livreEchangeId ?? '')),
                              style: const TextStyle(
                                fontSize: 12,
                        ...
                        Expanded(
                          child: Text(
                            ...
                            style: TextStyle(
                              fontSize: 12,
                              color:
                                  CouleursApp.texteFonce.withValues(alpha: 0.8),
                              height: 1.3,
                            ),
                          ),
                        ),
                ...
                Row(
                  children: [
                    ...
                    if (transaction.statut == 'en_attente' && estVendeur) ...[
                      ...
                      OutlinedButton(
                        onPressed: () => _afficherSucces(
                            'Fonctionnalité d\'annulation à implémenter'),
                        style: OutlinedButton.styleFrom(
                          foregroundColor:
                              CouleursApp.texteFonce.withValues(alpha: 0.6),
                          side: BorderSide(
                      ...
                      OutlinedButton.icon(
                        onPressed: () =>
                            _afficherSucces('Suivi de transaction activé'),
                        icon: Icon(Icons.visibility,
                            size: 14, color: couleurSection),
                        label: Text('Suivre',
                            style:
                                TextStyle(fontSize: 12, color: couleurSection)),
                        style: OutlinedButton.styleFrom(
                    ...
                    Expanded(
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          border: Border.all(
                            color:
                                CouleursApp.texteFonce.withValues(alpha: 0.1),
                            width: 1,
                          ),
                        ),
                        child: Row(
  ...
  String _obtenirNomLivre(String livreId) {
    try {
      ...
      // Si pas trouvé localement, essayer de le récupérer depuis le repository
      _chargerLivreManquant(livreId);
      return 'Chargement...';
    }
  }
      ...
      child: Column(
        ...
        children: [
          ...
          ListTile(
            ...
            title: Text(livre.estDisponible
                ? 'Suspendre l\'échange'
                : 'Remettre en échange'),
            onTap: () {
              Navigator.pop(context);
    ...
    return _ModalModificationLivre(
      ...
      onLivreModifie: (livreModifie) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content:
                Text('Livre "${livreModifie.titre}" modifié avec succès !'),
            backgroundColor: Colors.green,
            behavior: SnackBarBehavior.floating,
          ),
        );
        ...
        if (mounted) {
          ...
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(
              ...
              backgroundColor:
                  livre.estDisponible ? Colors.orange : Colors.green,
              behavior: SnackBarBehavior.floating,
            ),
          );
        }
                  ...
                  Row(
                    children: [
                      const Icon(Icons.filter_list,
                          color: CouleursApp.principal, size: 28),
                      const SizedBox(width: 12),
                      Text(
                        'Filtrer les livres',
                        style: StylesTexteApp.titre.copyWith(fontSize: 20),
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    DropdownButtonFormField<String>(
                      ...
                      items: LivresUtils.matieresDisponibles
                    ...
                    DropdownButtonFormField<String>(
                      ...
                      items: LivresUtils.anneesEtudeDisponibles
                    ...
                    Row(
                      children: [
                        ...
                        Expanded(
                          child: ElevatedButton(
                            onPressed:
                                _sauvegardeEnCours ? null : _sauvegarderLivre,
                            style: ElevatedButton.styleFrom(
                              backgroundColor: CouleursApp.accent,
                              padding: const EdgeInsets.symmetric(vertical: 12),
                              shape: RoundedRectangleBorder(
    ...
    if (_formKey.currentState!.validate() && widget.utilisateurActuel != null) {
      ...
      try {
        ...
        final nouveauLivre = Livre(
          ...
          proprietaire:
              '${widget.utilisateurActuel!.prenom} ${widget.utilisateurActuel!.nom}',
                ...
                TextFormField(
                  ...
                  decoration: InputDecoration(
                    ...
                    border: OutlineInputBorder(
                        borderRadius: BorderRadius.circular(12)),
                    prefixIcon:
                        const Icon(Icons.book, color: CouleursApp.principal),
                  ),
                  validator: (value) {
                    if (value == null || value.isEmpty) {
                ...
                TextFormField(
                  ...
                  decoration: InputDecoration(
                    ...
                    border: OutlineInputBorder(
                        borderRadius: BorderRadius.circular(12)),
                    prefixIcon:
                        const Icon(Icons.person, color: CouleursApp.principal),
                  ),
                  validator: (value) {
                    if (value == null || value.isEmpty) {
                ...
                DropdownButtonFormField<String>(
                  ...
                  decoration: InputDecoration(
                    ...
                    border: OutlineInputBorder(
                        borderRadius: BorderRadius.circular(12)),
                    prefixIcon:
                        const Icon(Icons.school, color: CouleursApp.principal),
                  ),
                  hint: const Text('Sélectionnez une matière'),
                  items: _matieres
                      .map((matiere) => DropdownMenuItem(
                ...
                DropdownButtonFormField<String>(
                  ...
                  decoration: InputDecoration(
                    ...
                    border: OutlineInputBorder(
                        borderRadius: BorderRadius.circular(12)),
                    prefixIcon:
                        const Icon(Icons.grade, color: CouleursApp.principal),
                  ),
                  hint: const Text('Sélectionnez une année'),
                  items: _anneesEtude
                      .map((annee) => DropdownMenuItem(
                ...
                DropdownButtonFormField<String>(
                  ...
                  decoration: InputDecoration(
                    ...
                    border: OutlineInputBorder(
                        borderRadius: BorderRadius.circular(12)),
                    prefixIcon:
                        const Icon(Icons.star, color: CouleursApp.principal),
                  ),
                  items: ['Excellent', 'Très bon', 'Bon', 'Acceptable']
                      .map((etat) => DropdownMenuItem(
                            value: etat,
                    ...
                    children: [
                      ...
                      Expanded(
                        child: Text(
                          ...
                          style: TextStyle(
                              fontSize: 12, color: CouleursApp.texteFonce),
                        ),
                      ),
                    ],
                  ),
